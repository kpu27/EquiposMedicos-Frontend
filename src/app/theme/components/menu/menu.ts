...
export const verticalMenuItems = [ 
    new Menu (1, 'Dashboard', '/', null, 'dashboard', null, false, 0, roles),
    new Menu (100, 'Home', null, null, 'home', null, true, 0, roles),
    ...
    new Menu (150, 'Tecnicos', '/tecnicos', null, 'person_pin', null, false, 0, roles),
    new Menu (151, 'Mantenimientos', '/tecnicos/mantenimientos-r', null, 'person_pin', null, false, 0, role_admin),
